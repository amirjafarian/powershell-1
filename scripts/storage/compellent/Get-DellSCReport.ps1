...
{
    $ScVolumeStorageUsage = Get-DellScVolumeStorageUsage -Instance $ScVolume.InstanceId
    ...
    $ScVolumePercentFull = [math]::Round(($ScVolumeStorageUsage.ActiveSpace.ByteSize/$ScVolume.ConfiguredSize.ByteSize)*100, 2)

    $object | Add-Member -MemberType NoteProperty -Name '% Full' -Value $ScVolumePercentFull
    $object | Add-Member -MemberType NoteProperty -Name 'Active Space' -Value $ScVolumeStorageUsage.ActiveSpace
    $object | Add-Member -MemberType NoteProperty -Name 'Snapshot Overhead' -Value $ScVolumeStorageUsage.ReplaySpace
    $object | Add-Member -MemberType NoteProperty -Name 'Actual Space' -Value $ScVolumeStorageUsage.ActualSpace
    $object | Add-Member -MemberType NoteProperty -Name 'Total Disk Space' -Value $ScVolumeStorageUsage.TotalDiskSpace
    $object | Add-Member -MemberType NoteProperty -Name 'Volume Folder Path' -Value $ScVolume.VolumeFolderPath
