...
if ($ComputerName) {
    ...
    if ($output.'CVE-2017-5754 mitigated' -eq $true) #Meltdown
    {
        [string]$CVE20175754mitigated = "true"
    }
    else
    {
        [string]$CVE20175754mitigated = "false"
    }

    if ($output.'CVE-2017-5715 mitigated' -eq $true) #Spectre
    {
        [string]$CVE20175715mitigated = "true"
    }
    else
    {
        [string]$CVE20175715mitigated = "false"
    }

    if ($output.'CVE-2017-5753 mitigated in Edge' -eq $true) #Spectre
    {
        [int]$CVE20175753mitigatedEdge = 1
    }
    elseif ($output.'CVE-2017-5753 mitigated in Edge' -eq $null)
    {
        [int]$CVE20175753mitigatedEdge = 0
    }
    else
    {
        [int]$CVE20175753mitigatedEdge = 2
    }

    if ($output.'CVE-2017-5753 mitigated in IE' -eq $true) #Spectre
    {
        [int]$CVE20175753mitigatedIE = 1
    }
    elseif ($output.'CVE-2017-5753 mitigated in IE' -eq $null)
    {
        [int]$CVE20175753mitigatedIE = 0
    }
    else
    {
        [int]$CVE20175753mitigatedIE = 2
    }

    if ($output.'CVE-2017-5753 mitigated in Chrome' -eq $true) #Spectre
    {
        [int]$CVE20175753mitigatedChrome = 1
    }
    elseif ($output.'CVE-2017-5753 mitigated in Chrome' -eq $null)
    {
        [int]$CVE20175753mitigatedChrome = 0
    }
    else
    {
        [int]$CVE20175753mitigatedChrome = 2    
    }

    if ($output.'CVE-2017-5753 mitigated in Firefox' -eq $true) #Spectre
    {
        [int]$CVE20175753mitigatedFirefox = 1
    }
    elseif ($output.'CVE-2017-5753 mitigated in Firefox' -eq $null)
    {
        [int]$CVE20175753mitigatedFirefox = 0
    }
    else
    {
        [int]$CVE20175753mitigatedFirefox = 2   
    }

    $AVCompatibilityStatus = $output.AVCompatibility

    if ($AVCompatibilityStatus -eq $true)
    {
        [string]$AVCompatibilityStatus = "true"
    }
    else
    {
        [string]$AVCompatibilityStatus = "false"    
    }
<#
    Write-Host $CVE20175754mitigated
    Write-Host $CVE20175715mitigated
    Write-Host $CVE20175753mitigatedEdge
    Write-Host $CVE20175753mitigatedIE
    Write-Host $CVE20175753mitigatedChrome
    Write-Host $CVE20175753mitigatedFirefox
#>
}