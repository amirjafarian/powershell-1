...
function Write-Log
{
    ...
    (
        ...
        [Alias('LogPath')]
        [string]$Path="C:\Logs\Create-CheckCentralReport.log",
    ...
    else
    {
        ...
        foreach ($CheckGroup in $CheckGroups)
        {
            ...
            * {font-family: Sans-serif;}
            ...
            $tableColGroup = "<colgroup><col/><col/><col/><col/><col/></colgroup>"
            $tableHeaderTitles = "<tr><th>ID</th><th>Name</th><th>Description</th><th>Status</th><th>Updated</th></tr>"
            ...
            foreach ($check in $AllChecksInGroup)
            {
                ...
                [void]$HTMLBody.Append("<tr><td>$checkId</td><td>$checkName</td><td>$checkDescription</td><td class=`"$checkStatus`">$checkStatus</td><td>$checkUpdated</td></tr>`n")
            }
